...
/** Portable SHA-256 used to bind a resumable recognition job to its exact source bytes. */
    ...
    fun sha256(source: ByteArray): String {
        ...
        while (block < padded.size) {
            ...
            repeat(64) { index ->
                ...
                val first = h + sum1 + choose + constants[index] + words[index]
